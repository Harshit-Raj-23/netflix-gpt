...
const Login = () => {
  ...
  return (
    <div>
      ...
      <form className="w-3/12 absolute p-12 my-36 mx-auto right-0 left-0 bg-black opacity-80 text-white rounded-lg">
        ...
        <input
          ...
          className="p-3 mb-4 w-full rounded-sm bg-black border-2 border-gray-700"
        />
        <button type="submit" className="p-4 my-4 w-full bg-red-700 rounded-lg">
          {isSignInForm ? "Sign In" : "Sign Up"}
        </button>
